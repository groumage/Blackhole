...
class BlockchainOrganizationComponent(BaseOrganizationComponent):
    ...
    def register_components(
        ...
        realm: BlockchainRealmComponent,
        **other_components
    ):
    ...
    async def stats(self, id: OrganizationID) -> OrganizationStats:
        ...
        metadata_size = 0
        for (vlob_organization_id, _), vlob in self._vlob_component._get_items():
